...
def load_db():
    users={}
    with open("F:\\Desarrollador\\CoderHouse\\Preentraga\\pre_1\\usuarios.csv",encoding="utf-8") as file:
...
def add_user(bd_users):
    ...
    with open("F:\\Desarrollador\\CoderHouse\\Preentraga\\pre_1\\usuarios.csv", "a",encoding="utf-8", newline="") as file:
